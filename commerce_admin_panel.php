        ...
        function renderCards() {
            ...
            grid.innerHTML = visible.map((row) => {
                ...
                return `<div class="cm-card" data-id="${esc(row.id)}">
                    <div class="cm-card__title">${title}</div>
                    <div class="cm-card__meta">${sub}</div>
        ...
        <div class="card">
            <div class="card-header card-no-border pb-0 d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                    ...
                    <p class="text-muted small mb-0">Facturi fiscale legate de comenzi (ca besoiupieseauto).</p>
                </div>
...
function blu_render_website_admin_panel(): void
{
    ...
    ?>
    <div class="card">
        <div class="card-header card-no-border pb-0"><h4>Pagini site</h4></div>
        <div class="card-body">
            <p class="text-muted">Pagini statice ale magazinului Blue-Car. Editează conținutul direct în fișierele PHP din rădăcină.</p>
            <div class="list-group">
                <a class="list-group-item list-group-item-action" href="../index.php" target="_blank" rel="noopener">Magazin — index.php</a>
                <a class="list-group-item list-group-item-action" href="../contact.php" target="_blank" rel="noopener">Contact — contact.php</a>
                <a class="list-group-item list-group-item-action" href="../cos.php" target="_blank" rel="noopener">Coș — cos.php</a>
                <a class="list-group-item list-group-item-action" href="../login.php" target="_blank" rel="noopener">Login clienți — login.php</a>
            </div>
        </div>
    </div>
    <?php
