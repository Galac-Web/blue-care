...
if (Test-Path -LiteralPath $templateAssets) {
    Copy-Item -LiteralPath $templateAssets -Destination (Join-Path $resolvedTarget 'assets') -Recurse -Force
} else {
    Write-Warning "Nu am gasit asset-urile template-ului: $templateAssets"
}
